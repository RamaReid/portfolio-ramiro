...
| D14 | Alojamiento, dominio y publicación | Confirmado por Ramiro al elegir la alternativa explicada | GitHub Pages sobre el repositorio `RamaReid/portfolio-ramiro`, con URL inicial `https://ramareid.github.io/portfolio-ramiro/`; dominio propio queda para una etapa posterior |
